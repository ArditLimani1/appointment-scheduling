...
return [
    ...
    'steps' => [
        ...
        'full_name' => 'Full Name',
        'phone' => 'Phone number (with prefix, e.g. +383)',
        'phone_hint' => 'If you want confirmation messages and other appointment details, enter your WhatsApp number.',
        'phone_required_error' => 'Enter the phone number.',
    ...
    'confirmation' => [
        ...
        'confirmed_summary' => 'Appointment summary',
        ...
        'confirmed_note' => 'Need to change or cancel? Contact the business as soon as possible.',
