...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Reader-friendly names for the form fields used throughout the app, so
    | default validation messages refer to fields with their human label
    | rather than the underlying technical key.
    |
    */
    ...
    'attributes' => [
        ...
        'business_type_category_id' => 'business category',
        ...
        'min_booking_notice' => 'minimum booking notice',
        'max_booking_window' => 'maximum booking window',
