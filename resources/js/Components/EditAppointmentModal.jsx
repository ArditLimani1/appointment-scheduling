...
export default function EditAppointmentModal({
    ...
    const inputCls =
        'w-full rounded-xl border border-slate-200 bg-white px-3 py-3 text-base text-on-surface focus:outline-none focus:ring-2 focus:ring-on-surface/10 sm:text-sm';
                    ...
                    {tabs.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex flex-1 items-center justify-center gap-1.5 border-b-2 px-0.5 py-3 text-sm font-semibold transition-colors sm:mr-6 sm:flex-none sm:justify-start sm:py-2 ${
                                    activeTab === tab.id
                        ...
                        {effectiveReadOnly ? (
                            <div className="flex w-full justify-end">
                                <button
                                    type="button"
                                    onClick={onClose}
                                    className="w-full rounded-xl bg-on-surface px-5 py-3 text-sm font-bold text-surface transition-opacity hover:opacity-90 sm:w-auto sm:py-2"
                                >
                            ...
                            <>
                                ...
                                <div className="flex w-full items-center gap-2 sm:w-auto">
                                    <button
                                        type="button"
                                        onClick={onClose}
                                        className="flex-1 rounded-xl border border-slate-200 px-4 py-3 text-sm font-semibold text-on-surface transition-colors hover:bg-slate-50 sm:flex-none sm:py-2"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="flex-1 rounded-xl bg-on-surface px-5 py-3 text-sm font-bold text-surface transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40 sm:flex-none sm:py-2"
                                    >
