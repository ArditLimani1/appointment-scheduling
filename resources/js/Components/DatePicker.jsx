...
export default function DatePicker({ value, onChange, placeholder = 'Select date', label }) {
    ...
    return (
        <div className="flex flex-col gap-1.5">
            ...
            {/* ── Mobile: native date input (shown below md, hidden md+) ── */}
            <div className="md:hidden flex flex-col gap-1.5">
                ...
                <div className="relative flex items-center">
                    ...
                    <input
                        ...
                        className="w-full min-w-[180px] rounded-xl border border-slate-200 bg-white pl-9 pr-4 py-2.5 text-sm text-on-surface font-medium focus:outline-none focus:ring-2 focus:ring-on-surface/10 appearance-none"
                    />
                </div>
            </div>

            {/* ── Desktop: custom calendar picker (hidden below md, shown md+) ── */}
            <div className="hidden md:flex md:flex-col md:gap-1.5" ref={containerRef}>
                {labelEl}
